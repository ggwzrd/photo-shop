...
buyer2 = User.create( {name: "Armando", email: "pim@gmail.com", role: "buyer", password: "abcd1234"} )
seller1 = User.create( {name: "Irene", email: "miriam@gmail.com", role: "seller", password: "abcd1234"} )
...
product1 = Product.create ( {name: "Print 5x5 Framed Black", price: 1.00, description: Faker::Hipster.paragraph, photos: [photo1], user: seller1, categories: [category1] } )
product2 = Product.create ( {name: "Print 13x18 Framed Black", price: 2.00, description: Faker::Hipster.paragraph, photos: [photo2], user: seller2, categories: [category2] } )
product3 = Product.create ( {name: "Print 10x10 Framed Black", price: 3.00, description: Faker::Hipster.paragraph, photos: [photo3], user: seller3, categories: [category3] } )
product4 = Product.create ( {name: "Print 30x30 Framed Black", price: 4.00, description: Faker::Hipster.paragraph, photos: [photo4], user: seller2, categories: [category1, category2, category3] } )
product5 = Product.create ( {name: "Print 5x5 Framed Sirver", price: 5.00, description: Faker::Hipster.paragraph, photos: [photo5], user: seller1, categories: [category1, category3] } )
product6 = Product.create ( {name: "Print 13x18 Framed Sirver", price: 6.00, description: Faker::Hipster.paragraph, photos: [photo6], user: seller2, categories: [category1, category2] } )
product7 = Product.create ( {name: "Print 10x10 Framed Sirver", price: 7.00, description: Faker::Hipster.paragraph, photos: [photo7], user: seller3, categories: [category1, category2, category3] } )
product8 = Product.create ( {name: "Print 75x50 Framed Sirver", price: 17.00, description: Faker::Hipster.paragraph, photos: [photo8], user: seller2, categories: [category2, category3] } )
product9 = Product.create ( {name: "Print 30x30 Framed Sirver", price: 1.00, description: Faker::Hipster.paragraph, photos: [photo9], user: seller3, categories: [category1, category2, category3] } )
product10 = Product.create ( {name: "Print 75x50 Framed Sirver", price: 3.00, description: Faker::Hipster.paragraph, photos: [photo10], user: seller2, categories: [category1, category2] } )
product11 = Product.create ( {name: "Print 75x50 Framed Sirver", price: 4.00, description: Faker::Hipster.paragraph, photos: [photo11], user: seller1, categories: [category1, category2, category3] } )
product12 = Product.create ( {name: "Print 75x50 Framed Sirver", price: 9.00, description: Faker::Hipster.paragraph, photos: [photo12], user: seller2, categories: [category2, category3] } )
